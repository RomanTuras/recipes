...
class ThemeState {
  ...
  ThemeState copyWith({ThemeStatus? status, String? errorMessage, ThemeEntity? themeEntity}) => ThemeState._(status: status ?? this.status, errorMessage: errorMessage ?? this.errorMessage, themeEntity: themeEntity ?? this.themeEntity);
}